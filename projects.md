...
### Формат сдачи
Загрузить в [таблицу](https://docs.google.com/spreadsheets/d/1VGo73BlNC9ldbSPNEK-WI1BpW1DH-j-WBXQvfZDaA8c/edit?usp=sharing) в соответствующее поле черновик постера в pdf и план публикации с учётом фидбека по предыдущим этапам.
...
### Формат сдачи
Загрузить в [таблицу](https://docs.google.com/spreadsheets/d/1VGo73BlNC9ldbSPNEK-WI1BpW1DH-j-WBXQvfZDaA8c/edit?usp=sharing) в соответствующее поле финальный постер в pdf и подготовиться к публичной защите проекта.
