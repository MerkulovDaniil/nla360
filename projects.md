...
## Выбор темы проекта и команды
🗓 15 марта. 🦄 2 балла

Выбрать команду для проекта. Размер команды - 3-5 человек.
...
Для удобства приведен [📝 $\LaTeX$ шаблон](/projects/poster_template.zip) с [📜 примером](/projects/poster_template.pdf).
