...
|-|------------|------------|
|  1  |  [Арифметика чисел с плавающей запятой. Векторные нормы. Устойчивость](lectures/lecture-1/lecture-1.ipynb)  | [Числа с плавающей запятой, число обусловленности](seminars/seminar-1/seminar-1.ipynb) |
